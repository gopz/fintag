...
require_relative "fintag/csv_processors/ft_csv_parsable"
...
require_relative "fintag/csv_processors/ft_chase_csv"
...
Logging.logger["FtChaseCsv"].level = :info
Logging.logger["FtTaggable"].level = :info
Logging.logger["FtParsable"].level = :info
